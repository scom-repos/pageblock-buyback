(() => {
  ...
  var import_global6 = __toModule(__require("@buyback/global"));
  var import_store6 = __toModule(__require("@buyback/store"));
  var import_assets4 = __toModule(__require("@buyback/assets"));
  ...
  var import_store = __toModule(__require("@buyback/store"));
  var import_global = __toModule(__require("@buyback/global"));
  ...
  // src/result/result.tsx
  var import_assets = __toModule(__require("@buyback/assets"));
  ...
  Result = __decorateClass([
    (0, import_components2.customElements)("buyback-result")
  ], Result);
  ...
  // src/buyback/buyback.css.ts
  var import_components3 = __toModule(__require("@ijstech/components"));
  var import_assets2 = __toModule(__require("@buyback/assets"));
  var colorVar = {
  ...
  import_components3.Styles.cssRule(".pageblock-buyback", {
    $nest: {
      "i-label": {
        fontFamily: "Montserrat Regular",
        color: "#fff"
  ...
  // src/buyback/index.tsx
  var import_queue_utils = __toModule(__require("@buyback/queue-utils"));

  // src/buyback/panelConfig/panel-config.tsx
  var import_components9 = __toModule(__require("@ijstech/components"));
  var import_global5 = __toModule(__require("@buyback/global"));

  // src/buyback/panelConfig/panel-config.css.ts
  var import_components4 = __toModule(__require("@ijstech/components"));
  import_components4.Styles.cssRule(".panel-config", {
    background: "#192046",
    padding: "1rem",
    margin: "auto",
    $nest: {
  ...
  // src/buyback/panelConfig/panel-config.tsx
  var import_store5 = __toModule(__require("@buyback/store"));

  // src/buyback/panelConfig/buyback.tsx
  var import_components8 = __toModule(__require("@ijstech/components"));
  var import_global4 = __toModule(__require("@buyback/global"));
  var import_store4 = __toModule(__require("@buyback/store"));

  // src/token-selection/tokenSelection.tsx
  var import_components6 = __toModule(__require("@ijstech/components"));
  var import_store2 = __toModule(__require("@buyback/store"));
  var import_global2 = __toModule(__require("@buyback/global"));
  var import_assets3 = __toModule(__require("@buyback/assets"));

  // src/token-selection/tokenSelection.css.ts
  var import_components5 = __toModule(__require("@ijstech/components"));
  import_components5.Styles.cssRule(".token-selection", {
    $nest: {
      "#tokenSearch": {
        width: "100% !important"
      },
  ...
  // src/token-selection/tokenSelection.tsx
  var TokenSelection = class extends import_components6.Module {
    constructor(parent, options) {
      super(parent, options);
      ...
      this.$eventBus = import_components6.application.EventBus;
      this.registerEvent();
    }
    get token() {
      return this._token;
    ...
    get chainId() {
      ...
      return (0, import_store2.isWalletConnected)() ? this.currentChainId : (0, import_store2.getChainId)();
    }
    get disableSelect() {
    ...
    async initData() {
      if (!this.chainId) {
        this.currentChainId = (0, import_store2.getChainId)();
      }
      if ((0, import_store2.isWalletConnected)()) {
        this.tokenBalancesMap = (0, import_store2.getTokenBalances)();
      }
      this.renderTokenItems();
    }
    async updateDataByChain(init) {
      this.tokenBalancesMap = await (0, import_store2.updateAllTokenBalances)();
      this.renderTokenItems();
    ...
    async onWalletConnect() {
      this.checkHasMetaMask = (0, import_store2.hasMetaMask)();
      await this.initData();
    ...
    registerEvent() {
      this.$eventBus.register(this, import_global2.EventId.IsWalletConnected, this.onWalletConnect);
      this.$eventBus.register(this, import_global2.EventId.IsWalletDisconnected, this.onWalletDisconnect);
      this.$eventBus.register(this, import_global2.EventId.chainChanged, this.onChainChange);
      this.$eventBus.register(this, import_global2.EventId.Paid, this.onPaid);
      this.$eventBus.register(this, import_global2.EventId.EmitNewToken, this.updateDataByNewToken);
    }
    get tokenDataList() {
      if (this.tokenDataListProp && this.tokenDataListProp.length) {
        return this.tokenDataListProp;
      }
      const tokenList = (0, import_store2.getTokenList)(this.chainId).filter((f) => f.address);
      return tokenList.map((token) => {
        var _a;
        const tokenObject = __spreadValues({}, token);
        const nativeToken = import_store2.ChainNativeTokenByChainId[this.chainId];
    ...
    async renderCommonItems() {
      ...
      if (this.isCommonShown && this.commonTokenDataList) {
        ...
        this.commonTokenDataList.forEach((token) => {
          const logoAddress = token.address && !this.targetChainId ? (0, import_store2.getTokenIcon)(token.address) : import_assets3.default.fullPath((0, import_store2.getTokenIconPath)(token, this.chainId));
          this.commonTokenList.appendChild(/* @__PURE__ */ this.$render("i-hstack", {
            ...
            height: 24,
            url: logoAddress,
            fallbackUrl: import_store2.fallBackUrl
          }), /* @__PURE__ */ this.$render("i-label", {
    ...
    renderToken(token) {
      ...
      return /* @__PURE__ */ this.$render("i-hstack", {
        ...
        onClick: () => import_components6.application.copyToClipboard(token.address || ""),
        ...
        class: "ml-auto",
        caption: (0, import_global2.formatNumber)(token.balance, 4),
        onClick: () => this.onSelect(token)
    ...
    async renderTokenItems() {
      ...
      if (this.tokenDataListFiltered.length) {
      ...
      } else if (this.targetChainId && this.targetChainId !== (0, import_store2.getChainId)()) {
        this.tokenList.innerHTML = "";
        ...
        try {
          const tokenObj = await (0, import_store2.getTokenObject)(this.filterValue, true);
          if (!tokenObj)
    ...
    addToMetamask(event, token) {
      ...
      const img = `${window.location.origin}${(0, import_store2.getTokenIconPath)(token, this.chainId).substring(1)}`;
    ...
    updateStatusButton() {
      const status = (0, import_store2.isWalletConnected)();
      if (this.btnToken) {
    ...
    updateButton(token) {
      ...
      try {
        ...
        if (!token) {
          ...
          const logoAddress = token.address && !this.targetChainId ? (0, import_store2.getTokenIcon)(token.address) : import_assets3.default.fullPath((0, import_store2.getTokenIconPath)(token, this.chainId));
          if (!image) {
            image = new import_components6.Image(btnToken, {
              width: 20,
              height: 20,
              fallbackUrl: import_store2.fallBackUrl
            });
    ...
    async onSelect(token, isNew = false) {
      this.token = token;
      if (!isNew && token.isNew && !(0, import_store2.hasUserToken)(token.address || "", this.chainId)) {
        (0, import_store2.setUserTokens)(token, this.chainId);
        (0, import_store2.setTokenMap)();
        await (0, import_store2.setTokenBalances)();
        this.$eventBus.dispatch(import_global2.EventId.EmitNewToken, token);
        isNew = true;
      }
  ...
  var import_global3 = __toModule(__require("@buyback/global"));
  var import_store3 = __toModule(__require("@buyback/store"));
  var ImportToken = class extends import_components7.Module {
    constructor(parent, options) {
      super(parent, options);
      this._state = {
        address: "",
    ...
    async onImportToken(source, event) {
      ...
      (0, import_store3.addUserTokens)(tokenObj);
      (0, import_store3.setTokenMap)();
      await (0, import_store3.setTokenBalances)();
      this.$eventBus.dispatch(import_global3.EventId.EmitNewToken, tokenObj);
    ...
    viewContract() {
      ...
      (0, import_store3.viewOnExplorerByAddress)(chainId, this._state.address);
    }
    async init() {
      super.init();
  ...
  ImportToken = __decorateClass([
    (0, import_components7.customElements)("import-token")
  ], ImportToken);

  // src/buyback/panelConfig/buyback.tsx
  var CampaignConfig = class extends import_components8.Module {
    constructor(parent, options) {
      super(parent, options);
      this.isInitialized = false;
      this.setupInput = () => {
        ...
        if (this.data) {
          ...
          const interval = setInterval(async () => {
            if (this.isInitialized) {
              ...
              const tokenMap = (0, import_store4.getTokenMap)();
      ...
      this.emitInput = () => {
        import_components8.application.EventBus.dispatch(import_global4.EventId.EmitInput);
      };
      this.onInputIndex = () => {
      ...
      this.checkValidation = () => {
        return !!this.inputName.value && this.fromToken && this.toToken && (0, import_global4.isValidNumber)(this.inputOfferIndex.value) && (0, import_global4.isValidNumber)(this.inputPrice.value) && (0, import_global4.isValidNumber)(this.inputAmount.value) && (0, import_global4.isValidNumber)(this.inputCommittedAmount.value);
      };
      this.getData = () => {
        var _a, _b;
        const buyback = {
          ...
          tokenIn: ((_a = this.toToken) == null ? void 0 : _a.address) || "",
          tokenOut: ((_b = this.fromToken) == null ? void 0 : _b.address) || "",
  ...
  CampaignConfig = __decorateClass([
    (0, import_components8.customElements)("campaign-config")
  ], CampaignConfig);

  // src/buyback/panelConfig/panel-config.tsx
  var PanelConfig = class extends import_components9.Module {
    constructor(parent, options) {
      super(parent, options);
      this.registerEvent = () => {
        this.$eventBus.register(this, import_global5.EventId.EmitInput, this.updateButton);
        this.$eventBus.register(this, import_global5.EventId.IsWalletConnected, this.renderUI);
        this.$eventBus.register(this, import_global5.EventId.IsWalletDisconnected, this.renderUI);
        this.$eventBus.register(this, import_global5.EventId.chainChanged, this.onChangeChanged);
      };
      this.renderUI = () => {
        const isConnected = (0, import_store5.isWalletConnected)();
        this.networkElm.visible = !isConnected;
        this.buybackCampaignElm.visible = isConnected;
        this.updateNetworkName((0, import_store5.getChainId)());
      };
      ...
      this.onDownload = (data) => {
        if (this.isNew && data) {
          (0, import_global5.downloadJsonFile)("buyback.json", __spreadValues({}, data));
          return;
        }
        if (this.checkValidation()) {
          const buyback = this.getBuybackData();
          (0, import_global5.downloadJsonFile)("buyback.json", buyback);
        }
      };
  ...
  PanelConfig = __decorateClass([
    (0, import_components9.customElements)("panel-config")
  ], PanelConfig);

  // src/buyback/index.tsx
  var import_swap_utils = __toModule(__require("@buyback/swap-utils"));
  var BuybackBlock = class extends import_components10.Module {
    constructor(parent, options) {
      super(parent, options);
      ...
      this.onChainChange = async () => {
        const isConnected = (0, import_store6.isWalletConnected)();
        this.onSetupPage(isConnected);
      };
      this.initWalletData = async () => {
        let accountsChangedEventHandler = async (account) => {
          (0, import_store6.setTokenMap)();
        };
        let chainChangedEventHandler = async (hexChainId) => {
          (0, import_store6.setTokenMap)();
        };
        const selectedProvider = localStorage.getItem("walletProvider");
        const isValidProvider = Object.values(import_eth_wallet2.WalletPlugin).includes(selectedProvider);
        if (!import_eth_wallet2.Wallet.getInstance().chainId) {
          import_eth_wallet2.Wallet.getInstance().chainId = (0, import_store6.getDefaultChainId)();
        }
        if ((0, import_store6.hasWallet)() && isValidProvider) {
          await (0, import_store6.connectWallet)(selectedProvider, {
      ...
      this.onSetupPage = async (connected, hideLoading) => {
        ...
        try {
          this.buybackInfo = await (0, import_queue_utils.getGuaranteedBuyBackInfo)(this.data);
          this.renderBuybackCampaign();
          const firstToken = this.getTokenObject("toTokenAddress");
          if (firstToken && firstToken.symbol !== ((_a = import_store6.ChainNativeTokenByChainId[(0, import_store6.getChainId)()]) == null ? void 0 : _a.symbol)) {
      ...
      this.initInputFile = (importFileElm) => {
        ...
        const inputElm = (_a = importFileElm.firstChild) == null ? void 0 : _a.firstChild;
        if (inputElm) {
      ...
      this.convertJSONToObj = async (result) => {
        ...
        try {
          ...
          } else if (campaignObj.chainId && campaignObj.chainId !== (0, import_store6.getChainId)()) {
            const networkName = (0, import_store6.getNetworkInfo)(campaignObj.chainId) ? (0, import_store6.getNetworkInfo)(campaignObj.chainId).name : `ChainId = ${campaignObj.chainId}`;
      ...
      this.getFirstAvailableBalance = () => {
        ...
        const tokenBalances = (0, import_store6.getTokenBalances)();
        const balance = new import_eth_wallet2.BigNumber(available).times(offerPrice).dividedBy(tradeFee);
        const tokenBalance = new import_eth_wallet2.BigNumber(tokenBalances[this.getValueByKey("toTokenAddress")]);
        const amountIn = new import_eth_wallet2.BigNumber(amount).times(offerPrice).dividedBy(tradeFee);
        return import_eth_wallet2.BigNumber.minimum(balance, tokenBalance, amountIn).toFixed();
      };
      this.getSecondAvailableBalance = () => {
        ...
        return new import_eth_wallet2.BigNumber(this.getFirstAvailableBalance()).dividedBy(offerPrice).times(tradeFee).toFixed();
      };
      ...
      this.firstInputChange = () => {
        ...
        (0, import_global6.limitInputNumber)(this.firstInput, (firstToken == null ? void 0 : firstToken.decimals) || 18);
        if (!this.buybackInfo)
          return;
        const info = this.buybackInfo.queueInfo || {};
        const { offerPrice, tradeFee } = info;
        const firstSymbol = (firstToken == null ? void 0 : firstToken.symbol) || "";
        const inputVal = new import_eth_wallet2.BigNumber(this.firstInput.value).dividedBy(offerPrice).times(tradeFee);
        if (inputVal.isNaN()) {
          this.lbFee.caption = `0 ${firstSymbol}`;
          this.secondInput.value = "";
        } else {
          this.lbFee.caption = `${(0, import_global6.formatNumber)(new import_eth_wallet2.BigNumber(1).minus(tradeFee).times(this.firstInput.value), 6)} ${firstSymbol}`;
          this.secondInput.value = (0, import_global6.limitDecimals)(inputVal, (secondToken == null ? void 0 : secondToken.decimals) || 18);
        }
        this.updateBtnSwap();
      };
      this.secondInputChange = () => {
        const firstToken = this.getTokenObject("toTokenAddress");
        const secondToken = this.getTokenObject("fromTokenAddress");
        (0, import_global6.limitInputNumber)(this.secondInput, (secondToken == null ? void 0 : secondToken.decimals) || 18);
        if (!this.buybackInfo)
          return;
        const info = this.buybackInfo.queueInfo || {};
        const { offerPrice, tradeFee } = info;
        const firstSymbol = (firstToken == null ? void 0 : firstToken.symbol) || "";
        const inputVal = new import_eth_wallet2.BigNumber(this.secondInput.value).multipliedBy(offerPrice).dividedBy(tradeFee);
        if (inputVal.isNaN()) {
          this.firstInput.value = "";
          this.lbFee.caption = `0 ${firstSymbol}`;
        } else {
          this.firstInput.value = (0, import_global6.limitDecimals)(inputVal, (firstToken == null ? void 0 : firstToken.decimals) || 18);
          this.lbFee.caption = `${(0, import_global6.formatNumber)(new import_eth_wallet2.BigNumber(1).minus(tradeFee).times(this.firstInput.value), 6)} ${firstSymbol}`;
        }
        this.updateBtnSwap();
      };
      this.updateBtnSwap = () => {
        ...
        const firstVal = new import_eth_wallet2.BigNumber(this.firstInput.value);
        const secondVal = new import_eth_wallet2.BigNumber(this.secondInput.value);
      ...
      this.onSubmit = async () => {
        ...
        this.showResultMessage(this.buybackResult, "warning", `Swapping ${(0, import_global6.formatNumber)(this.firstInput.value)} ${firstToken == null ? void 0 : firstToken.symbol} to ${(0, import_global6.formatNumber)(this.secondInput.value)} ${secondToken == null ? void 0 : secondToken.symbol}`);
        const params = {
          provider: "RestrictedOracle",
          queueType: import_global6.QueueType.GROUP_QUEUE,
          routeTokens: [firstToken, secondToken],
          bestSmartRoute: [firstToken, secondToken],
          pairs: [pairAddress],
          fromAmount: new import_eth_wallet2.BigNumber(this.firstInput.value),
          toAmount: new import_eth_wallet2.BigNumber(this.secondInput.value),
          isFromEstimated: false,
          groupQueueOfferIndex: offerIndex
        };
        const { error } = await (0, import_swap_utils.executeSwap)(params);
        if (error) {
      ...
      this.initApprovalModelAction = async () => {
        this.approvalModelAction = await (0, import_swap_utils.getApprovalModelAction)({
          sender: this,
          ...
          onPaid: async (data) => {
            await (0, import_store6.setTokenBalances)();
            await this.onSetupPage((0, import_store6.isWalletConnected)(), true);
            this.firstInput.value = "";
            this.secondInput.value = "";
            this.btnSwap.rightIcon.visible = false;
            this.btnSwap.caption = this.submitButtonText;
        ...
        (0, import_swap_utils.setApprovalModalSpenderAddress)(import_store6.Market.HYBRID);
        const firstToken = this.getTokenObject("toTokenAddress");
      ...
      this.initEmptyUI = async () => {
        if (!this.noCampaignSection) {
          this.noCampaignSection = await import_components10.Panel.create({ height: "100%" });
        }
        const isConnected = (0, import_store6.isWalletConnected)();
        ...
        let onClose;
        if (isBtnShown) {
          importFileElm = await import_components10.Label.create({ visible: false });
        ...
        this.noCampaignSection.appendChild(/* @__PURE__ */ this.$render("i-panel", {
          ...
          font: { color: "#FFFFFF" },
          caption: isConnected ? "No Buybacks" : "Please connect with your wallet!"
          ...
          maxWidth: 220,
          caption: "Import Buyback Campaign",
          class: "btn-os btn-import",
          font: { size: "14px" },
      ...
      this.renderBuybackCampaign = async () => {
        if (this.buybackInfo) {
          ...
          const firstSymbol = (0, import_store6.tokenSymbol)(this.getValueByKey("toTokenAddress"));
          const vStackTimer = await import_components10.VStack.create({ gap: 4, verticalAlignment: "center" });
          const lbTimer = await import_components10.Label.create({ caption: "Starts In", font: { size: "12px" } });
          lbTimer.classList.add("opacity-50");
          const endHour = await import_components10.Label.create();
          const endDay = await import_components10.Label.create();
          const endMin = await import_components10.Label.create();
          ...
          vStackTimer.appendChild(/* @__PURE__ */ this.$render("i-panel", {
            lineHeight: "29px"
          }, /* @__PURE__ */ this.$render("i-hstack", {
            gap: 4,
            verticalAlignment: "center",
            class: "custom-timer"
          }, endDay, /* @__PURE__ */ this.$render("i-label", {
            caption: "D",
            class: "timer-unit"
          }), endHour, /* @__PURE__ */ this.$render("i-label", {
            caption: "H",
            class: "timer-unit"
          }), endMin, /* @__PURE__ */ this.$render("i-label", {
            caption: "M",
            class: "timer-unit"
          }))));
          const vStackEndTime = await import_components10.VStack.create({ gap: 4, verticalAlignment: "center" });
          const lbEndTime = await import_components10.Label.create({ caption: "Estimated End Time", font: { size: "12px" } });
          lbEndTime.classList.add("opacity-50");
          vStackEndTime.appendChild(lbEndTime);
          vStackEndTime.appendChild(/* @__PURE__ */ this.$render("i-label", {
            caption: (0, import_global6.formatDate)(info.endDate),
          ...
          const setTimer = () => {
            ...
            let hours = 0;
            let mins = 0;
            if ((0, import_moment.default)().isBefore((0, import_moment.default)(startDate))) {
              lbTimer.caption = "Starts In";
              lbEndTime.caption = "Estimated End Time";
              days = (0, import_moment.default)(startDate).diff((0, import_moment.default)(), "days");
              hours = (0, import_moment.default)(startDate).diff((0, import_moment.default)(), "hours") - days * 24;
              mins = (0, import_moment.default)(startDate).diff((0, import_moment.default)(), "minutes") - days * 24 * 60 - hours * 60;
            } else if ((0, import_moment.default)((0, import_moment.default)()).isBefore(endDate)) {
              lbTimer.caption = "Ends In";
              vStackEndTime.visible = false;
              days = (0, import_moment.default)(endDate).diff((0, import_moment.default)(), "days");
              hours = (0, import_moment.default)(endDate).diff((0, import_moment.default)(), "hours") - days * 24;
              mins = (0, import_moment.default)(endDate).diff((0, import_moment.default)(), "minutes") - days * 24 * 60 - hours * 60;
            } else {
          ...
          this.buybackElm.clearInnerHTML();
          this.buybackElm.appendChild(/* @__PURE__ */ this.$render("i-panel", {
            class: "pnl-buy-back",
            padding: { bottom: 15, top: 15, right: 15, left: 15 },
            height: "auto"
          }, /* @__PURE__ */ this.$render("i-hstack", {
            gap: 10,
            verticalAlignment: "center",
            ...
            width: 36,
            height: 36,
            url: (0, import_store6.getTokenIcon)(tokenOut),
            fallbackUrl: import_store6.fallBackUrl
          }), /* @__PURE__ */ this.$render("i-image", {
            width: 24,
            height: 24,
            url: (0, import_store6.getTokenIcon)(tokenIn),
            fallbackUrl: import_store6.fallBackUrl,
            position: "absolute",
            bottom: -4,
            left: 24
            ...
            caption: projectName || "",
            margin: { top: 4 },
            font: { size: "20px", color: "#FF6363", name: "Montserrat Bold", bold: true }
          })), /* @__PURE__ */ this.$render("i-hstack", {
            gap: 60,
            width: "100%",
            verticalAlignment: "center"
            ...
            caption: `${1 / this.getValueByKey("offerPrice")} ${(0, import_store6.tokenSymbol)(this.getValueByKey("fromTokenAddress"))}`,
            font: { size: "24px", color: "#72F35D", bold: true },
            lineHeight: "29px"
          })), vStackTimer, vStackEndTime), /* @__PURE__ */ this.$render("i-hstack", {
            gap: 20,
            margin: { top: 15 },
            verticalAlignment: "center"
          }, /* @__PURE__ */ this.$render("i-vstack", {
            ...
            caption: `Balance: ${(0, import_global6.formatNumber)(this.getFirstAvailableBalance())} ${firstSymbol}`,
            font: { size: "12px" },
            class: "opacity-50",
            margin: { left: "auto" }
          })), /* @__PURE__ */ this.$render("i-hstack", {
            ...
            border: { radius: 16, width: 2, style: "solid", color: "transparent" },
            ...
            width: 20,
            height: 20,
            url: (0, import_store6.getTokenIcon)(this.getValueByKey("toTokenAddress")),
            fallbackUrl: import_store6.fallBackUrl
          }), /* @__PURE__ */ this.$render("i-label", {
            caption: firstSymbol,
            font: { size: "16px" }
            ...
            width: 20,
            height: 20,
            url: (0, import_store6.getTokenIcon)(this.getValueByKey("fromTokenAddress")),
            fallbackUrl: import_store6.fallBackUrl
          }), /* @__PURE__ */ this.$render("i-label", {
            caption: (0, import_store6.tokenSymbol)(this.getValueByKey("fromTokenAddress")),
            font: { size: "16px" }
          })), /* @__PURE__ */ this.$render("i-input", {
            id: "secondInput",
            inputType: "number",
      ...
      this.init = async () => {
        ...
        this.initWalletData();
        (0, import_store6.setDataFromSCConfig)(import_store6.Networks, import_store6.InfuraId);
        (0, import_store6.setCurrentChainId)((0, import_store6.getDefaultChainId)());
        if (!this.data) {
          await this.renderEmpty();
        }
      };
      this.$eventBus = import_components10.application.EventBus;
      this.registerEvent();
    }
    validateConfig() {
    }
    ...
    async setData(value) {
      ...
      this.pnlConfig.visible = false;
      this.buybackLayout.visible = true;
      this.onSetupPage((0, import_store6.isWalletConnected)());
    }
    async getTag() {
      return this.tag;
    }
    ...
    get isSwapDisabled() {
      ...
      const isUpcoming = (0, import_moment.default)().isBefore((0, import_moment.default)(startDate));
      const isEnded = (0, import_moment.default)().isAfter((0, import_moment.default)(endDate));
      if (isUpcoming || isEnded) {
        return true;
      }
      if (!allowAll) {
        const address = (0, import_store6.getWallet)().address;
    ...
    get submitButtonText() {
      ...
      if (this.isApproveButtonShown) {
        return ((_a = this.btnSwap) == null ? void 0 : _a.rightIcon.visible) ? "Approving" : "Approve";
      }
      const firstVal = new import_eth_wallet2.BigNumber(this.firstInput.value);
      const secondVal = new import_eth_wallet2.BigNumber(this.secondInput.value);
      ...
      if (this.buybackInfo) {
        const firstMaxVal = new import_eth_wallet2.BigNumber(this.getFirstAvailableBalance());
        const secondMaxVal = new import_eth_wallet2.BigNumber(this.getSecondAvailableBalance());
        if (firstVal.gt(firstMaxVal) || secondVal.gt(secondMaxVal)) {
          return "Insufficient amount available";
        }
      }
      if ((_b = this.btnSwap) == null ? void 0 : _b.rightIcon.visible) {
        return "Swapping";
      }
      return "Swap";
    }
    render() {
      return /* @__PURE__ */ this.$render("i-panel", {
        id: "buybackComponent",
        class: "pageblock-buyback",
        minHeight: 200
      }, /* @__PURE__ */ this.$render("i-panel", {
        id: "buybackLayout",
        class: "buyback-layout",
        width: maxWidth,
        height: maxHeight
      }, /* @__PURE__ */ this.$render("i-vstack", {
        id: "loadingElm",
  ...
  BuybackBlock = __decorateClass([
    import_components10.customModule,
    (0, import_components10.customElements)("i-section-buyback")
  ], BuybackBlock);
})();
